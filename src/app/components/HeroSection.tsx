...
const PLACEHOLDER_PROMPTS = [
  'A neon-soaked Miami Vice region where gang leaders are gym bosses and starter Pokémon are inspired by flamingos, gators, and manatees...',
  'Post-apocalyptic wasteland region. Radiation zones replace gyms. Rival is a scavenger with a mutated Eevee...',
  'Medieval Japan — feudal lords are Elite Four, starters are Pokémon based on koi, cranes, and tigers...',
  'Underwater kingdom 3000m deep. No land routes. Submarines replace bikes. Eight coral reef gym leaders...',
  'Mars Colony, 2157. Terraformed routes. Starter Pokémon evolved from Earth creatures sent in early missions...',
];
...
export default function HeroSection() {
  ...
  const handlePromptChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    setPromptValue(val);
    if (val.toLowerCase().includes('ghostmode.pokeforge')) {
      ...
      >
        ...
        >
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground font-medium leading-relaxed max-w-2xl mx-auto mb-12">
            Type any world. PokéForge generates a{' '}
            <span className="text-primary font-bold">fully playable Pokémon game</span>{' '}
          ...
          <div id="forge" className="relative max-w-3xl mx-auto group">
            ...
            <div className="relative glass-card rounded-2xl p-3 sm:p-4">
              <textarea
                ...
                aria-label="Describe your Pokémon world"
              />
