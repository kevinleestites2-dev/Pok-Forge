...
const features = [
  ...
  },
  {
    ...
    description:
      'Three starter Pokémon designed for your world. A full eight-badge storyline with twists, lore, and an endgame that fits your setting. No cookie-cutter plots.',
