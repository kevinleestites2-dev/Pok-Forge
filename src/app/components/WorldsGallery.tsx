...
},
{
  ...
  prompt: 'Terraformed Martian routes, starter Pokémon from Earth mission animals',
  biome: 'Sci-Fi / Barren',
  gyms: 8,
...
},
{
  ...
  prompt: 'Cyberpunk Tokyo, digital Pokémon manifested from corrupted data streams',
