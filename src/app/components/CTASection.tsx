...
const EXAMPLE_PROMPTS = [
  ...
  'Ancient Egypt, Pokémon based on gods and desert creatures...',
  'The Moon — low gravity routes, crater gyms, starter Pokémon evolved from meteorites...',
];
      ...
      <div ref={leftRef} className="w-full lg:w-1/2 bg-secondary flex items-center justify-center p-10 sm:p-16 lg:p-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-muted-foreground text-base sm:text-lg leading-relaxed mb-10 max-w-sm">
            No account needed to try. Describe your world below and watch PokéForge bring it to life in seconds.
          </p>
