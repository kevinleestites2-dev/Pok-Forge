...
export async function POST(req: NextRequest) {
  try {
    ...
    const systemPrompt = godMode
      ? `You are a master game world architect. The user has unlocked GOD MODE — ALL genre restrictions are removed. Generate ANY type of game world they describe, not just Pokémon. Be bold, creative, and epic.`
      : `You are a master Pokémon world architect. Generate rich, detailed Pokémon game worlds based on user descriptions. Be creative and original.`;
...
Generate a complete game world in this EXACT JSON format:
{
  ...
  "starters": [
    { "name": "Starter name", "type": "Fire", "secondType": "Dark", "description": "Brief description", "emoji": "🔥" },
    { "name": "Starter name", "type": "Water", "secondType": null, "description": "Brief description", "emoji": "💧" },
    { "name": "Starter name", "type": "Grass", "secondType": "Poison", "description": "Brief description", "emoji": "🌿" }
  ],
  "gymLeaders": [
